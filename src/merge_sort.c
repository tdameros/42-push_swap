...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/11 20:11:00 by tomy              #+#    #+#             */
/*   Updated: 2023/01/11 20:11:00 by tomy             ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int	merge_sort(int *tab, int index_left, int index_right)
{
	...
	if (index_left < index_right)
	{
		...
		if (merge_sort(tab, index_left, middle) < 0)
			return (-1);
		if (merge_sort(tab, middle + 1, index_right) < 0)
			return (-1);
